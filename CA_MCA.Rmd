...
levels(df$f.outlierPCAd1) <- c("OutlierD1","NormalD1")
levels(df$f.outlierPCAd2) <- c("OutlierD2","NormalD1")
levels(df$f.outlierPCAd3) <- c("OutlierD3","NormalD3")
levels(df$f.outlierPCAd4) <- c("OutlierD4","NormalD4")
levels(df$f.outlierPCA) <- c("Outlier","Normal")
...
vec_out <- which(df$f.outlierPCA == "YesOut"); length(vec_out)
