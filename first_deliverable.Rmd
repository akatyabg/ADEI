...
#save.image("Taxi5000_raw_DataDefinitivev1.RData") # Dont execute again since it will create a new data and the following code must be ajusted..
```
...
##f.ttime
```{r}
df$f.ttime<-factor(cut(df$travel_time,breaks=c(-1,6,9.78,15.7,215)))
summary(df$f.ttime)
```
