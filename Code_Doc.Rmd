...
summary(df[,vars_con])
vars_con_out<-vars_con2[c(1:4)]
vars_con2<-names(df)[c(6,8)] 
dim(vars_con2)
aq.plot(df[,6-7],delta=qchisq(0.95,
df=ncol(x)),alpha=0.05) # Problems when few numeric values are present in one variable
