...
requiredPackages <- c("effects","FactoMineR","car", "factoextra","RColorBrewer","ggplot2","missMDA","mvoutlier","dplyr","caret", "ggmap","ggthemes","knitr","MVA", "ROCR", "zoom")
...
xpea<-sum(residuals(m2,'pearson')^2);xpea

qqnorm(rstudent(m2))

#Residuals
residualPlots(m51) 
residualPlot(m2, variable = "fitted", type = "pearson", plot = TRUE, quadratic = FALSE)
