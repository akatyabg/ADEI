...
In the plots below two big elements can be clearly distinguished over the rest: 759257 and 199161 (in the boxplot 1844 and 512 but are the same elements).
One of them (the first one) has almost a 7 times bigger cook distance value compared to the second and it is a clearly outlier from rstudent boxplot.
