...
```{r}
#Block C individus
#parangons. per cadascun dels clusters tenim els seus parangons i els seus mis espeicifis (dist) -> que es diferencien mis dels altres clusters
res.hcpc$desc.ind
```
...
#No ens hem de preocupar de la clase outliers, nomis caracteritizar els clusters del metode per defecte que genera la classificaci jerarquica. 
